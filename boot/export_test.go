...
func MockFDEHookProtector(f func(*snap.Info) (secboot.KeyProtectorFactory, error)) (restore func()) {
	oldFDEHookProtector := FDEHookProtector
	FDEHookProtector = f
	return func() {
		FDEHookProtector = oldFDEHookProtector
	}
}
